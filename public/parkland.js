...
function generateParkland() {
  ...
  problemInfo.textContent = `You have a patient who weighs ${problem.weight} lbs. They are burned on ${problem.bsa}% of their body. Please determine how many mL's you will give them over the next 24 hours (remember you give half the total amount in the first 8 hours). You will also need to determine how many drips per minute you will need to give to meet this required amount, you will be using a 15gtt drip set.`;
}
...
function checkAnswer() {
  ...
  let mLRange = {
    upper: solution.firstGiven["4mL"] + 2,
    lower: solution.firstGiven["2mL"] - 2,
  };
